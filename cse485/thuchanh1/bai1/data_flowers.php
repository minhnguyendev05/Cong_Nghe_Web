...
$data = [
    [
        ...
        "images" => ["dayenthao_1.jpg", "dayenthao_2.jpg"]
    ],
    [
        "name" => "Hoa đồng tiền",
        ...
        "images" => ["dongtien_1.jpg", "dongtien_2.jpg"]
    ],
    [
        "name" => "Hoa giấy",
        ...
        "images" => ["hoagiay_1.jpg", "hoagiay_2.jpg"]
    ],
    [
        "name" => "Hoa thanh tú",
        ...
        "images" => ["thanhtu_1.jpg", "thanhtu_2.jpg"]
    ],
    [
        "name" => "Hoa đèn lồng",
        ...
        "images" => ["denlong_1.jpg", "denlong_2.jpg"]
    ],
    [
        "name" => "Hoa cẩm chướng",
        ...
        "images" => ["camchuong_1.jpg", "camchuong_2.jpg"]
    ],
    [
        "name" => "Hoa huỳnh anh",
        "description" => "Nếu bạn đang đi tìm một loài hoa tô điểm cho khu vực ban công hoặc hàng rào ngôi nhà thì huỳnh anh là một lựa chọn thích hợp trong mùa này hơn cả. Hoa có màu vàng rực, hình dạng như chiếc kèn be bé xinh xinh, lại dễ trồng, mọc nhanh, vươn cao… Huỳnh Anh rất thích nắng, ánh nắng giúp hoa tỏa sáng rực rỡ, nếu ở nơi bóng râm thì chúng sẽ nhạt màu, kém sắc.",
        "images" => ["huynhanh_1.jpg", "huynhanh_2.jpg"]
    ],
    [
        "name" => "Hoa Păng-xê",
        ...
        "images" => ["pangxe_1.jpg", "pangxe_2.jpg"]
    ],
    [
        "name" => "Hoa sen",
    ...
    [
        ...
        "images" => ["duacan_1.jpg", "duacan_2.jpg"]
    ],
    [
        "name" => "Hoa sử quân tử",
        ...
        "images" => ["suquantu_1.jpg", "suquantu_2.jpg"]
    ],
    [
        "name" => "Cúc lá nho",
        ...
        "images" => ["cuclanho_1.jpg", "cuclanho_2.jpg"]
    ],
    [
        "name" => "Cẩm tú cầu",
        ...
        "images" => ["camtucau_1.jpg", "camtucau_2.jpg"]
    ],
    [
        "name" => "Hoa cúc dại",
        ...
        "images" => ["cucdai_1.jpg", "cucdai_2.jpg"]
    ],
]
